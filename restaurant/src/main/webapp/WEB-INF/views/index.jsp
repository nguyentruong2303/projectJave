...
<body>
					...
					<ul>
						...
						<li class="sub-li">
							...
							<div aria-labelledby="dropdown-a"class="header-submenu"id="s1"style="position:relative;display:none;">
								<a href="<%=contextPath%>/booking" id="a-1">RESERVATION</a>
								<a href="<%=contextPath%>/postList"id="a-1">STUFF</a>
								<a href="<%=contextPath%>/postList"id="a-1">GALLERY</a>
							</div>
						</li>
						<li class="sub-li">
							...
							<div aria-labelledby="dropdown-a" class="header-submenu"id="s2"style="position:relative;display:none;">
								<a href="<%=contextPath%>/tagList"id="a-1">BLOG</a>
								<a href="<%=contextPath%>/tagList"id="a-1">BLOG SINGLE</a>
							</div>
						</li>
	...
	<!-- Start slides -->
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
			  <img src="resources/images/slider-01.jpg" style="width:100%;height: 100vh;">
			...
			<div class="mySlides fade">
			  <img src="resources/images/slider-02.jpg" style="width:100%;height: 100vh;">
			  <div class="text">Welcome To <br> Live Dinner Restaurant</div>
			  <div class="numbertext">See how your users experience your website in realtime or view <br> trends to see any changes in performance over time.</div>
			  <div class="info-slide"><a href="#">RESERVATION</a></div>
			</div>
			...
			<div class="mySlides fade">
			  <img src="resources/images/slider-03.jpg" style="width:100%;height: 100vh;">
					...
					<div class="gallery-row1">
						<div class="gallery-pic1"onmouseover="changeSize('picG1')"onmouseout="returnSize('picG1')">
							<a href="resources/images/gallery-img-01.jpg">
								<img src="resources/images/gallery-img-01.jpg"id="picG1"class="pic-change" alt="Gallery Images"style="width:340px;height:230px;">
							</a>
						</div>
						<div class="gallery-pic1"onmouseover="changeSize('picG2')"onmouseout="returnSize('picG2')">
							<a href="resources/images/gallery-img-02.jpg">
								<img src="resources/images/gallery-img-02.jpg"id="picG2"class="pic-change" alt="Gallery Images"style="width:340px;height:230px;">
							</a>
						</div>
						<div class="gallery-pic1"onmouseover="changeSize('picG3')"onmouseout="returnSize('picG3')">
							<a href="resources/images/gallery-img-03.jpg">
								<img src="resources/images/gallery-img-03.jpg" id="picG3"class="pic-change"alt="Gallery Images"style="width:340px;height:230px;">
							</a>
						</div>
					</div>
					<div class="gallery-row1">
						<div class="gallery-pic1"onmouseover="changeSize('picG4')"onmouseout="returnSize('picG4')">
							<a href="resources/images/gallery-img-04.jpg">
								<img src="resources/images/gallery-img-04.jpg"id="picG4"class="pic-change" alt="Gallery Images"style="width:340px;height:230px;">
							</a>
						</div>
						<div class="gallery-pic1"onmouseover="changeSize('picG5')"onmouseout="returnSize('picG5')">
							<a href="resources/images/gallery-img-05.jpg">
								<img src="resources/images/gallery-img-05.jpg"id="picG5"class="pic-change" alt="Gallery Images"style="width:340px;height:230px;">
							</a>
						</div> 
						<div class="gallery-pic1"onmouseover="changeSize('picG6')"onmouseout="returnSize('picG6')" >
							<a href="resources/images/gallery-img-06.jpg">
								<img src="resources/images/gallery-img-06.jpg"id="picG6"class="pic-change" alt="Gallery Images"style="width:340px;height:230px;">
							</a>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="resources/js/slide-cus.js"></script>
</body>
</html>