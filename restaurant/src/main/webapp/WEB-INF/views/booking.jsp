			...
			<div class="booking-option">
				<div >
					<div class="booking-form">
						  <form:form method="POST" action="bookList" modelAttribute="bookAttri">
  							
    						<form:input path="bkname" placeholder="Your Name"  /> <br>
    						<form:input path="bkemail" placeholder="Your Mail"/> <br>
    						<form:input path="bkphone" placeholder="Your Phone"/> <br>
    						<form:input type="datetime-local" path="bktime"/> <br>
    						<form:input path="bknum" placeholder="Your Num"/> <br>
    						<form:input path="booking" placeholder="Your Booking"/> <br>
    						<form:input path="bkmemo" placeholder="Your Memo"/> <br>
   							<input id="bookingbtn" type="submit" value="Booking" /> <br>
  							</form:form>
