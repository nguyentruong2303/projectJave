...
<body>
	...
	<div class="container-stuff">
		<div class="container-stuff1">
			<div class="stuff-top">
				<div class="stuff-top1">
			...
			<div class="stuff-main">
                <div class="stuff-total11">
                    <div class="stuff-sub1">
                        <div class="sub1-img">
			...
			<div class="customer-main">
				<div class="main-total">
					<div id="reviews" data-ride="carousel">
						...
						<a class="prev-cus11" onclick="prevCus()">&#10094;</a>
						<a class="next-cus11" onclick="nextCus()">&#10095;</a>
